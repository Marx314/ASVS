...
| **5.2.7** | #FIXME# Vérifiez que l'application désinfecte, désactive ou met en place des sandboxes pour le contenu scriptable fourni par l'utilisateur (Scalable Vector Graphics - SVG), en particulier en ce qui concerne les XSS résultant de scripts en ligne et foreignObject. | ✓ | ✓ | ✓ | 159 |
